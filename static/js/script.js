...
function action_trigger() {
    ...
    $.ajax({
        url: `https://serverforchatbot2.herokuapp.com/conversations/${user_id}/execute`,
        type: "POST",
...
function send(message) {
    ...
    $.ajax({
        url: "https://serverforchatbot2.herokuapp.com/webhooks/rest/webhook",
        type: "POST",
        contentType: "application/json",
...
function setBotResponse(response) {
    ...
    setTimeout(function() {
        ...
        if (response.length < 1) {
            //if there is no response from bot, send  fallback message to the user
...
// on click of quickreplies, get the value and send to bot
...
$(document).on("click", "#expand", function() {
    ...
    //the parameters are declared gloabally while we get the charts data from bot.
